...
// ---------------------FlattenedArrays Of Array Of Strings---------------------
...
const isAdultPerson = function (person) {
...
function testDomainNamesOf() {
  printMessage(
    domainNamesOf(["xyz@gmail.com", "you@yahoo.com"]),
    ["gmail.com", "yahoo.com"],
    areEqual1D
  );
}
...
function testSplitWordsOf() {
  printMessage(
    splitWordsOf(["namaste", "good morning"]),
    [["namaste"], ["good", "morning"]],
    areEqual2D
  );
}

function testJoinedArraysOf() {
  printMessage(
    joinedArraysOf([
      ["a", "b"],
      ["he", "llo"],
...
function testReversedWordsOf() {
  printMessage(
    reversedWordsOf(["hello world", "aa bb"]),
    ["olleh dlrow", "aa bb"],
    areEqual1D
  );
}
...
function testUniqueCharactersOf() {
  ...
  printMessage(
    uniqueCharactersOf(["apple", "grape"]),
    ["aple", "grape"],
    areEqual1D
  );
}
...
function testFlattenedArraysOf() {
  printMessage(
    flattenedArraysOf([
      [1, [2, 3]],
      [1, 2],
